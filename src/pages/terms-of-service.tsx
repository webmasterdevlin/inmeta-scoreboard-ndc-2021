...
const TermsOfServicePage = () => {
  return (
    <Layout title="Terms of Service | inmeta">
      ...
      <p>
        By accessing this Website, accessible from https://inmeta.no, you are
      ...
      <p>
        This will let inmeta to terminate upon violations of any of these
      ...
      <p>
        inmeta or its suppliers will not be hold accountable for any damages
        that will arise with the use or inability to use the materials on
        inmeta’s Website, even if inmeta or an authorize representative of this
      ...
      <p>
        The materials appearing on inmeta’s Website may include technical,
        typographical, or photographic errors. inmeta will not promise that any
        of the materials in this Website are accurate, complete, or current.
        inmeta may change the materials contained on its Website at any time
        without notice. inmeta does not make any commitment to update the
        materials.
      </p>
      ...
      <p>
        inmeta has not reviewed all of the sites linked to its Website and is
        not responsible for the contents of any such linked site. The presence
        of any link does not imply endorsement by inmeta of the site. The use of
      ...
      <p>
        inmeta may revise these Terms of Use for its Website at any time without
